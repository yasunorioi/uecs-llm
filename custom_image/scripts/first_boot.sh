...
SCRIPT_DIR="/opt/unipi-agri-ha/scripts"
CONFIG_DIR="/opt/unipi-agri-ha/config"
...
# Node-RED設定ファイルをコピー
NODERED_TEMPLATE="/opt/unipi-agri-ha/nodered"
...
0 3 * * * root /opt/unipi-agri-ha/scripts/backup_config.sh >> /var/log/backup.log 2>&1
CRON
